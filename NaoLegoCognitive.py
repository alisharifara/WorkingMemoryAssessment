...
def sendBlockList():
	imW = 200 #640 # image width
	imH =  200 #480 # image height
...
#ALI NaoSay("Hello! Thank you for playing my Lego Memory game. First, please ensure that the board in front of me is clear and you have logged into my webserver. My server address is 192.168.1.12 port 8 0 8 0.")
waitForHeadTouch()
